...
def main():
    ...
    deployment_group.add_argument('-r','--roaming', action='store_true', help='The roaming operator, it should be used with the Auth, Admin, Deoployment, Policies or Reports module')
    deployment_group.add_argument('-t','--tunnel', action='store_true', help='The tunnel operator, it should be used with the Auth, Admin, Deoployment, Policies or Reports module')
    deployment_group.add_argument('-nw','--networks', action='store_true', help='The network operator, it should be used with the Auth, Admin, Deoployment, Policies or Reports module')    
    deployment_group.add_argument('-po','--policies', action='store_true', help='The policies operator, it should be used with the Auth, Admin, Deoployment, Policies or Reports module')    
    deployment_group.add_argument('-id','--domains', action='store_true', help='The domains operator, it should be used with the Auth, Admin, Deoployment, Policies or Reports module')    
    deployment_group.add_argument('-in', '--internalNetworks', action='store_true', help='The internal networks operator, it should be used with the Auth, Admin, Deoployment, Policies or Reports module') 
    deployment_group.add_argument('-st', '--sites', action='store_true', help='The sites operator, it should be used with the Auth, Admin, Deoployment, Policies or Reports module')     
    deployment_group.add_argument('-va', '--virtualAppliances', action='store_true', help='The virtual appliances operator, it should be used with the Auth, Admin, Deoployment, Policies or Reports module')     
    deployment_group.add_argument('-nd', '--networkDevices', action='store_true', help='The network devices operator, it should be used with the Auth, Admin, Deoployment, Policies or Reports module')     
